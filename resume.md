...
3. **App Store submission**: `KelpieVault/App Store plan.md` is the checklist; everything below folds into it.
3a. Own push relay: deploy `relay/` as a Cloudflare Worker with Anthony's APNs key and point the app at it. Outward-facing, needs his explicit yes. Required for any App Store build.
