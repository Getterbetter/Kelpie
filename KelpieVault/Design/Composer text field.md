...
Shipped in round 18: `dabbc0f`, `dd7fc0d` (review fixes), `7fd4afa` (the field floats like the pill), `bb430cc` (the phone's menu button above it). Anthony: "it works well". Not in v1: a soft newline.
