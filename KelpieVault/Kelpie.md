...
- Branch `kelpie`, 103 commits on top of upstream Heeler `375267c` (re-parented 2026-09-12 after the round-11 history purge detached it, round 11b). Remotes `origin` (public github.com/Getterbetter/Kelpie, branch kelpie, pushed) and `upstream` (Heeler).
