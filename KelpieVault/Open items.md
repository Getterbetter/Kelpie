...
- [ ] **4b. App Store submission.** Everything up to the submit is done (round 8, see [[App Store plan]] status). Left: his three `--apply` runs and `--submit`; then delete the Hetzner review host after approval.
