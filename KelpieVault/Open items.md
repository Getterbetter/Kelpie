...
- [ ] **17. Load the Reddit watch** (`launchctl bootstrap gui/$(id -u) scripts/launchd/com.kelpie.redditwatch.plist`, Anthony's yes) and answer the first comment (u/Training_Mail_973, r/SideProject, photo resolution over SSH), then `scripts/redditwatch.py --answered t1_p9bp6zo`. See [[Reddit watch]].
