...
- [ ] **1d. Clipboard out: select text in herdr with the trackpad, paste into Notes.** Decides gap 2 in [[Mac vs iPad gaps]].
- [ ] **1e. Answer the two questions in [[Window size workshop]]** before the compact-widths round.
